...
export default function Hesabat() {
  ...
  const exportToExcel = () => {
    ...
    csvContent += "Tarix,Növ,İzahat,Məbləğ,Ödəniş Üsulu\n";
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1400px', margin: '0 auto', background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ fontSize: '14px', color: '#64748b', margin: '8px 0 0 0' }}>Yeni Heyat filialı</p>
      </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
              ...
              <th style={{ padding: '16px', textAlign: 'left', fontSize: '12px', fontWeight: '600', color: '#64748b', textTransform: 'uppercase' }}>İzahat</th>
