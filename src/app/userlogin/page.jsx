...
export default function UserLogin() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.user.role === 'admin') {
          ...
          setError('Naməlum rol təyin edilib!');
          return;
        }
  ...
  return (
    <div style={styles.container}>
      <div style={styles.loginForm}>
        <h2 style={styles.title}>İstifadəçi Girişi</h2>
        <p style={styles.subtitle}>Hesabınıza daxil olmaq üçün məlumatları daxil edin</p>
